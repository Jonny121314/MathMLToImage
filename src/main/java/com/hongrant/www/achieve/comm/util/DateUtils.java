...
public class DateUtils {
	...
	public final static String DATE_NUMERIC = "yyyyMMdd";

	public final static String DATE_TIME_NUMERIC = "yyyyMMddHHmmss";
	...
	public static Date stringToDate(String datestr) {
		if (StringUtils.isBlank(datestr)) {
			...
			if (length <= 10) {
				...
				return stringToDate(datestr, TIMESTAMP_FORMAT);
			}
			else {
				return stringToDate(datestr, DATE_FORMAT);
			}
	...
	public static void main(String[] args) {
		...
		String strBeginTime = DateUtils.dateToString(DateUtils.stringToDate("2018-04-04 10:44:59", DateUtils.DATE_TIME_FORMAT), "yyyy-MM-dd HH:mm").replaceFirst(" ", "T");
		System.err.println(strBeginTime);
